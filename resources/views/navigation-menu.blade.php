                ...
                <div class="flex items-center shrink-0">
                    @if(Auth::user()->role === 'student')
                        <a href="{{ route('student.dashboard') }}">
                            <x-application-mark2 class="block w-auto h-12" />
                        </a>
                ...
                <div class="relative ms-3">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <span class="inline-flex items-center px-3 py-2 font-medium leading-4 text-gray-500 transition duration-150 ease-in-out bg-white border border-transparent rounded-md text-m hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50">
                                        {{ Auth::user()->name }}
                                    </span>
                                    <button onclick="{{ route('logout') }}" class="px-4 py-2 text-gray-700 transition-colors border border-gray-300 rounded-lg hover:bg-gray-50">
                                        Logout
                                    </button>
                                </span>
                            @endif
